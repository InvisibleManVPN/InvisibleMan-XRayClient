...
namespace InvisibleGorillaXRay.Linux.Handlers
{
    ...
    /// <summary>
    /// Mirror of MacLocalizationHandler but resolves localization resources from the
    /// Linux assembly's own avares URI so the same XAML files compiled into this build
    /// are loaded at runtime.
    /// </summary>
    public class LinuxLocalizationHandler : Handler
    {
        ...
        private void ApplyLanguage(string language)
        {
            ...
            try
            {
                ...
                var uri = new Uri($"avares://InvisibleGorilla-XRay.Linux/Assets/Localization/{language}.axaml");
