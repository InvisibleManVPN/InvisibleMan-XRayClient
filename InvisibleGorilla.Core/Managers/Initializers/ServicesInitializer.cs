...
namespace InvisibleGorillaXRay.Managers.Initializers
{
    ...
    public class ServicesInitializer
    {
        ...
        public void Setup(HandlersManager handlersManager, Func<string, string> getLocalizedTerm)
        {
            SetupServiceLocator();
            ...
            {
                ServiceLocator.Setup(servicesManager: ServicesManager);
            }

            void SetupLocalizationService()
            {
                ServicesManager.GetService<LocalizationService>().Setup(getLocalizedTerm);
            }
